classdef (Abstract) RinexDataSet_bak < handle
...
%             self.data = table('Size',[0, size(self.variable_names_types,1)],... 
% 	                          'VariableNames', self.variable_names_types(:,1),...
% 	                          'VariableTypes', self.variable_names_types(:,2));
        end
