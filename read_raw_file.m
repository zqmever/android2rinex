function gnss_raw = read_raw_file(gnss_raw_file, all_fields)
    ...
    if nargin < 2
        all_fields = {'Raw', 'Status', 'Fix', 'OrientationDeg'};
    end
    gnss_raw = parse_raw_data(gnss_raw, raw_data, all_fields);
end
...
function gnss_raw = parse_raw_data(gnss_raw, raw_data, all_labels)
