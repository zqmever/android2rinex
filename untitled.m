...
BiasNanos1 = gnss_raw.Raw.BiasNanos;
...
this_line = sprintf('G    1%5d', 4*size(obs_code_gps, 1));
...
this_line = sprintf('R    1%5d', 4*size(obs_code_glo, 1));
...
fprintf(fid, '%-60sSYS / # / OBS TYPES \n', this_line);
this_line = sprintf('E    1%5d', 4*size(obs_code_gal, 1));
...
fprintf(fid, '%-60sSYS / # / OBS TYPES \n', this_line);
this_line = sprintf('C    1%5d', 4*size(obs_code_bds, 1));
